 ...
 * this
 * 
 * JS는 lexical Scope를 사용하기때문에 함수의 상위 스코프가 정의 시점에 펴악된다.
 * ⭐️⭐️⭐️ 하지만 this 키워드는 바인딩이 객체가 생성되는 시점에 결정된다.
 */
...
Person.prototype.dance = function () {
    function dance2() {
            return `${this.name}이 춤을 춥니다.`; // 글로벌로 맵핑
    }
 ...
 * 
 * 1) 일반 함수호출할땐 this가 최상위 객체 (global 또는 window)를 가리킨다.
